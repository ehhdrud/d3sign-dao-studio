    ...
    <div className="about">
      <div className="about-head">
        ...
        <p>
          ...
          digital artwork to the world. We are dedicated to creating a
      ...
      <div className="about-body">
        ...
        <p>
          ...
          approach enables us to provide personalized and customized digital art
          that caters to the unique needs and preferences of our customers.
        </p>
        ...
        <p>
          ...
          creating a welcoming space for dialogue and interaction, we nurture a
          thriving and interconnected art community.
        </p>

    ...
    <div className="artist-page">
      ...
      <div className="artist-card">
        ...
        <p>
          ...
          thought-provoking works that push the limits of conventional art
          genres.
        </p>
      </div>
      <div className="artist-card">
      ...
      <div className="artist-card">
        ...
        <p>
          ...
          organic forms, and unplanned brushstrokes. J1N's art enables viewers
          to go on a special, sensual trip by overcoming the limitations of
      ...
      <div className="artist-card">
        ...
        <p>
          ...
          and untold stories. Paul's art challenges viewers to examine their own
      ...
      <div className="artist-card">
        ...
        <span className="genre">"Cyberpunk"</span>
        <p>

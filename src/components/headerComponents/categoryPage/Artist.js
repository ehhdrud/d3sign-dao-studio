...
export default function Artist() {
  return (
    <div className="artist">
      ...
      <span className="name">CHR1S</span>
      ...
      <span className="name">MIRR0R</span>
      ...
      <span className="name">Paul0</span>

        ...
        <div className="container">
          ...
          <div className="artist-card">
            ...
            <p className="description">
              ...
              produce thought-provoking works that push the limits of
        ...
        <div className="container">
          ...
          <div className="artist-card">
            ...
            <p className="description">
              ...
              enables viewers to go on a special, sensual trip by overcoming the
        ...
        <div className="container">
          ...
          <div className="artist-card">
            ...
            <p className="description">
              ...
              emotions and untold stories. Paul's art challenges viewers to
              examine their own perceptions and experiences using a style that
              is both seductive and intriguing.
            </p>
          </div>
        </div>
      </Link>
        ...
        <div className="container">
          ...
          <div className="artist-card">
            ...
            <p className="description">
              ...
              with complex mechanical and robotic elements. Experience the art
              of R1N's endless possibilities and imaginative creations.
            </p>
          </div>
        </div>
      </Link>

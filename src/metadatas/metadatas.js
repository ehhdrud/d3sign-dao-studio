...
export const MetasPageArtsAndArtists = () => {
    return (
        <Helmet>
...
export const MetasPageMarketplace = () => {
    return (
        <Helmet>
